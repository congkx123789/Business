...
# ========================
ROOT_DIR = r"D:\Business\Self car web"   # <-- Đặt đường dẫn project của bạn (Windows dùng r"..." hoặc \\)
OUTPUT_FILE = r"D:\Business\Selfcarweb.txt"  # <-- Đặt đường dẫn file .txt đầu ra
...
DEFAULT_EXCLUDE_DIRS = {
    ...
    ".cache", "__pycache__", ".pytest_cache", "coverage","docs"
}
